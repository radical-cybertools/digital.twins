...
class HighModel(ModelInvestigator):
    def __init__(self, flow: WorkflowEngine):
        ...
        async def do_inference(in_data: JoinedTypedData):
            ...
            return TypedData(INFERENCE_DTYPE, f"{in_data.data} is HIGH!")
...
class LowModel(ModelInvestigator):
    def __init__(self, flow: WorkflowEngine):
        super().__init__(flow)
        self.flow = flow
        ...
        async def do_inference(in_data: JoinedTypedData):
            ...
            return TypedData(INFERENCE_DTYPE, f"{in_data.data} is LOW!")
